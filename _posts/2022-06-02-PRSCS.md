...
$\phi$ and $\psi$ formulate the shape parameters that describe the distribution of $/Beta$, which would convert to a Beta distribution with shape $/alpha$ and rate $/beta$, in the paper that best combination is a = 1 and b = 1/2.

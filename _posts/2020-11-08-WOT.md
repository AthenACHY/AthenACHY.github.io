...
After trying a few versions, it seems that python3.6 is the most compatible. I still encounter some issues though, as noted in the code blocks.#### Visualise input data
~~~ python
import numpy as np
import pandas as pd

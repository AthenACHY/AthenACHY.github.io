...
This time, I looked into the [evoracle](https://github.com/maxwshen/evoracle) package (paper: [Shen et al](https://doi.org/10.1038/s41589-021-00876-6
Reconstruction)) that is a new tool for profiling genotypes in directed evolution.
...
The pytorch code gave me some better ideas on how models are built and loss calculated, it also demonstrate a more compartmentalization of ML models and its implementation. 

...
Here, the authors of SCEPTRE ([github](https://katsevich-lab.github.io/sceptre/articles/sceptre-small-example.html#setup-and-data-1), [paper](https://doi.org/10.1186/s13059-021-02545-2))  looked into two high-MOI CRISPRi screen on enhancers and found that technical noise and expression disparity generate false positives.
...
The typical way of gene-expression correction from raw count/UMI of a gene per cell is to fit a negative binormial distribution on the gene expression values of a gene to model the mean and dispersion of the gene. 

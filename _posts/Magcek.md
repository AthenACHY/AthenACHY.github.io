...
Then, the probability ($$p(r_{k})$$) of obtaining *k* significant sgRNAs among N total sgRNAs in the pool in a null model threshold (5% significant level) is expressed as the binomial probability of picking such percentile rank in the null model.

To pool the multiple sgRNAs ranks targeting the same gene, MAGeCK only take the minimal $$p(r_{k})$$ among the filtered sgRNAs (i.e. NB p-values < 0.05) as the representative $$\rho$$-value for the gene. The final p-value of the gene significance were obtained from permutation test that pair sgRNAs and genes randomly. 
...
<figure>
<p align="left">
<img src="/img/posts/2020_08_MAGeCKFlute/RankView_sgRNA.png" width="400" height="400" title="Rank vire sgRNAs">
</p>
</figure>
...
<figure>
<p align="left">
<img src="/img/posts/2020_08_MAGeCKFlute/SquareView_Customized_Depmap.png" width="400" height="400" title="Rank vire sgRNAs">
</p>
</figure>
